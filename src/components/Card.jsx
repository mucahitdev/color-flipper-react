...
const Card = ({ avatar, role, listedBy, color: { renk1, renk2, renk3, renk4 } }) => {
        ...
        <div className='card w-full  sm:w-3/6   md:w-2/6  lg:w-1/5   px-2 mb-3'>
            <div className='border h-72 rounded-lg'>
                ...
                <div className="colors pt-1 h-4/5">
                    <ul className='h-full'>
                        <li className='h-1/4' style={{ backgroundColor: `${renk1}` }}> <span>{renk1}</span></li>
                        <li className='h-1/4' style={{ backgroundColor: `${renk2}` }}> <span>{renk2}</span> </li>
                        <li className='h-1/4' style={{ backgroundColor: `${renk3}` }}> <span>{renk3}</span> </li>
                        <li className='h-1/4' style={{ backgroundColor: `${renk4}` }}> <span>{renk4}</span> </li>
                    </ul>
                </div>
            </div>
        </div>
